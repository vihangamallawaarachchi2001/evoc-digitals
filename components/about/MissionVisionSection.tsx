        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className=" p-6 rounded-xl shadow-md">
            <div className="flex items-center mb-4">
              <ChartLine className="text-[#55C514] mr-2 text-2xl" />
              <h3 className="text-2xl text-[#55C514] font-bold ">Our Mission</h3>
            </div>
            <p className="mb-4">
            ...
            <div className="flex space-x-2 mt-4">
              <div className="w-12 h-12 bg-[#55C514]  rounded-full flex items-center justify-center">
                <ChartLine className="" />
              </div>
              <div className="w-12 h-12 bg-[#55C514]  rounded-full flex items-center justify-center">
                <Eye className="" />
          ...
          <div className=" p-6 rounded-xl shadow-md">
            <div className="flex items-center mb-4">
              <Globe className="text-[#55C514] mr-2 text-2xl" />
              <h3 className="text-2xl text-[#55C514] font-bold ">Our Vision</h3>
            </div>
            <p className="mb-4">
